...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandlePartyBotProtectCommand(char* args);
        bool HandlePartyBotUnprotectCommand(char* args);
        ...
        bool HandlePartyBotChangeSealCommand(char* args);
        bool HandlePartyBotChangeAuraCommand(char* args);
